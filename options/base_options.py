...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSize', type=int, default=320, help='scale images to this size')
        parser.add_argument('--fineSize', type=int, default=288, help='then crop to this size')
